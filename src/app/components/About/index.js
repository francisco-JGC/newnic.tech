      ...
      <div className="about-content__info">
        <div className="about-content__text">
          <p>
            ...
            soluciones de software personalizadas que se adaptan a tus
            necesidades específicas. Con un equipo apasionado y comprometido.
          </p>
          <p>
            Trabajamos incansablemente para impulsar la innovación y garantizar
            el éxito de nuestros clientes en el mundo digital. Nuestra prioridad
            es construir relaciones sólidas y duraderas mientras creamos
            tecnología que marque la diferencia en tu negocio.
          </p>
